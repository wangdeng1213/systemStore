 ...
 */
@Entity
@Table(name = "attachment_zqzr_attribute")
public class Attachment_zqzr_attribute extends BaseEntity {
    private static final long serialVersionUID = -42620068762432352L;
    @Id
