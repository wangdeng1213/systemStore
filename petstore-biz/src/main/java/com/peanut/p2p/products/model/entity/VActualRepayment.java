 ...
 */
@Entity
@Table(name = "v_actual_repayment")
@Cache(region = "vacCache", usage = CacheConcurrencyStrategy.READ_ONLY)
public class VActualRepayment extends BaseEntity {
    private static final long serialVersionUID = 7170516690078931757L;
    @Id
