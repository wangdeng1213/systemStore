 ...
 */
@QueryEntity(entityClazz = BoRepaymentDetail.class,alias = "bor")
public class BoRepaymentDetailQueryObject extends QueryObject{

    private static final long serialVersionUID = -2177956667459851169L;
    ...
    @QueryField(name = "repayment_startperiod",logicType = LogicType.and,genericOperator = GenericOperator.EQ)
    ...
    @QueryField(name = "finish_time",logicType = LogicType.and,genericOperator = GenericOperator.EQ)
    ...
    @QueryField(name = "product_name",logicType = LogicType.and,genericOperator = GenericOperator.EQ)
    ...
    @QueryField(name = "total_money",logicType = LogicType.and,genericOperator = GenericOperator.EQ)
