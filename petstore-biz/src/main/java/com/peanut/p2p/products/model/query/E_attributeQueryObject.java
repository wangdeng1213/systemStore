...
import com.peanut.p2p.products.model.entity.E_attribute;
 ...
 * @version 1.0
 */
@QueryEntity(entityClazz = E_attribute.class, alias = "e_attribute")
public class E_attributeQueryObject extends QueryObject {

    private static final long serialVersionUID = 8682962577608375352L;
