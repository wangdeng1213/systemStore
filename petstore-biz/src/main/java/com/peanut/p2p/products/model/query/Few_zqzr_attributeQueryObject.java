 ...
 * @version 1.0
 */
@QueryEntity(entityClazz = Few_zqzr_attribute.class, alias = "few_zqzr_attribute")
public class Few_zqzr_attributeQueryObject extends QueryObject {

    private static final long serialVersionUID = -7827018697523236673L;
