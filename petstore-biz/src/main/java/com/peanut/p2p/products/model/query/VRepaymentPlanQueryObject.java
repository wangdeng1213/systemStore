 ...
 */
@QueryEntity(entityClazz = VRepaymentPlan.class, alias = "vre")
public class VRepaymentPlanQueryObject extends QueryObject {

    private static final long serialVersionUID = -3670893758391602664L;
