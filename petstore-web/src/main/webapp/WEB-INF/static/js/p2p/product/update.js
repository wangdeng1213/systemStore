        ...
        $("tpay").val(tpay);
         ...
         if($('#productName').val()==null||$('#productName').val()==''){
          ...
          if($('#startTime').val()==null||$('#startTime').val()==''){
            alert("投资开始时间不能为空，请您输入投资开始时间！");
            $('#startTime').focus();
            return false;
          }
          //投资结束时间
          if($('#endTime').val()==null||$('#endTime').val()==''){
            alert("投资结束时间不能为空，请您输入投资结束时间！");
            $('#endTime').focus();
            return false;
          }else {
            ...
            var endNumber = parseInt($('#endTime').val().replace(/-/g, ''), 10 );
             if(startNumber > endNumber){
                alert("投资结束时间必须要大于投资开始时间，请重新输入投资结束时间！");
                $('#endTime').focus();
                return false;
             }
          }
         ...
         if($("#buy_type1").attr("checked")==true && ($('#p1').val()==null||$('#p1').val()=='')){
              alert("标的总份不能为空，请您输入标的总份！");
              $('#p1').focus();
              return false;
             }
            ...
            if($("#buy_type2").attr("checked")==true && ($('#to').val()==null||$('#to').val()=='')){
