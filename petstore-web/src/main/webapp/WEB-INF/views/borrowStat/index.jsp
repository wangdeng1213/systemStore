...
<body>
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span5" style="text-align: right">
				<div class="btn-group">
					<a href="#" class="btn btn-primary" onclick="gotoAdd('/borrowStat/add');">新增</a>
					<a href="#" class="btn" onclick="gotoImportExcel('/borrowStat/import');">导入excel</a>
					<a href="#" class="btn" onclick="gotoPreviewExcel('/borrowStat/gotoPreviewExcel');">预览excel</a>
				</div>
			</div>
		</div>
		<div class="row-fluid">
