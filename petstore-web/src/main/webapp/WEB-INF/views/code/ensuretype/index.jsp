...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			<form:form id="queryObjectForm" cssClass="form-inline"
						modelAttribute="ensureTypeQueryObject" action="/ensureType/query"
						method="GET">
				<fieldset>
					<legend>
					    <div class="row-fluid">
					...
					<div class="row-fluid">
						...
						<div class="span6" style="text-align: right">
							...
							<form:select path="orders[0].name">
								...
								<form:option value="id">保障方式ID</form:option>
								<form:option value="name">保障方式名称</form:option>
							</form:select>
						</div>
					</div>
				    <div class="row-fluid">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span7">
				<p class="lead">保障方式列表</p>
			</div>
			<div class="span5" style="text-align: right">
				<div class="btn-group">
					<a href="#" class="btn btn-primary" onclick="gotoAdd('/ensureType/add');">新增</a>
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<table class="table table-striped" >
				...
				<tbody id="tab">
					<c:forEach items="${ensureTypePage.records}" var="cur" varStatus="s">
						<tr>
							<td>
								${s.index+1 }
							</td>
