...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			<form:form id="queryObjectForm" cssClass="form-inline"
						modelAttribute="vActualRepaymentPlanQueryObject" action="/actualRepaymentPlan/queryList"
						method="GET">
				<fieldset>
					<legend>
					    <div class="row-fluid">
		...
		<div class="row-fluid">
			<div class="span7">
				<p class="lead"><font size="5"><strong>实际收益统计列表</strong></font></p>
			</div>
		</div>
		<div class="row-fluid">
			<table class="table table-striped">
				...
				<tbody>
					<c:forEach items="${vActualRepaymentPlanPage.records}" var="cur" varStatus="s">
						<tr>
							<td>
								${s.index+1 }
							</td>
			...
			<pager:legend bean="vActualRepaymentPlanPage" url="/actualRepaymentPlan/queryList"></pager:legend>
		</div>
	</div>	
	...
	<script type="text/javascript">
		...
		function downLoad(){
           document.forms[0].action="/actualRepaymentPlan/download";
           document.forms[0].submit();
           document.forms[0].action="/actualRepaymentPlan/queryList";
		}
	</script>
</body>