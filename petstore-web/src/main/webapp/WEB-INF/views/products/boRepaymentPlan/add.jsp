...
<body>
	<div class="container-fluid">
		<form:form cssClass="form-horizontal" modelAttribute="boRepaymentPlanModel"
			method="POST" action="/boRepaymentPlan/add">
			<fieldset>
				<legend>
					新增应付收益计划信息
				</legend>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<a class="btn" href="/boRepaymentPlan/query">取消</a>
					</div>
				</div>
			</fieldset>
		</form:form>
