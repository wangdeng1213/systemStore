...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			<form:form id="queryObjectForm" cssClass="form-inline"
						modelAttribute="productQueryObject" action="/product/queryMBList"
						method="GET">
				<fieldset>
					<legend>
					    <div class="row-fluid">
				    ...
				    <div class="row-fluid">
						<div class="span6">
							...
							<form:select path="productTypeCod" >
                             								...
                             								<form:option value="4">抵质押标</form:option>
                             							</form:select>
						</div>
					    <div class="span6" style="text-align: right">
					...
					<div class="row-fluid">
					      <div class="span6" >
 							...
 							<form:select path="statusCode" >
 								...
 								<form:option value="7">投标结束</form:option>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
				...
				<tbody id="tab">
					<c:forEach items="${productPage.records}" var="cur" varStatus="s">
						<tr>
							...
							<a href="/product/${cur.id}/toZZ"><button class="btn btn-primary" type="button">转账</button></a>
							<a href="/product/${cur.id}/queryTransaction"><button type="button" class="btn btn-primary">
                                                     	查询交易状态
                                                    </button></a>
							</td>
						</tr>
			...
			<pager:legend bean="productPage" url="/product/queryMBList"></pager:legend>
		</div>
	</div>
