	...
	<div class="container-fluid">
		<div class="row-fluid">
			<form:form id="queryObjectForm" cssClass="form-inline"
						modelAttribute="internetUserQueryObject" action="/user/loanApply/query"
						method="GET">
				<fieldset>
					<legend>
					    <div class="row-fluid">
				...
				<tbody>
					<c:forEach items="${internetUserPage.records}" var="cur" varStatus="s">
						<tr>
							...
							<td>
							<!--	<a href="<c:url value='/user/loanApply/${cur.id}/update'/>">修改</a>-->
								<a href="#" id="trash${s.index+1 }" rel="popover" data-placement="left" data-content='<form:form action="/user/loanApply/${cur.id}/delete" method="DELETE"><div class="control-group" style="text-align:center"><label class="control-label"></label><div class="controls"><button type="submit" class="btn btn-primary">是</button><a class="btn" href="#" onclick="hideTrash(trash${s.index+1 })">否</a></div></div></form:form>' title="请确定是否删除数据">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
